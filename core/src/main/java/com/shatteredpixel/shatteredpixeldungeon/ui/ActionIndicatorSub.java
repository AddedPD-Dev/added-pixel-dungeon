...
public class ActionIndicatorSub extends Tag {

	Image icon;

	public static Action action;
	public static ActionIndicatorSub instance;

	public ActionIndicatorSub() {
		super( 0xFFFF4C );
	...
	public static void setAction(Action action){
		ActionIndicatorSub.action = action;
		updateIcon();
	}

	public static void clearAction(Action action){
		if (ActionIndicatorSub.action == action)
			ActionIndicatorSub.action = null;
	}
